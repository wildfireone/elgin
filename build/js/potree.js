...
THREE.FirstPersonControls = function ( object, domElement ) {
	...
	this.update = function (delta) {
        ...
        //console.log("before: "+position.y);
        //position = new THREE.Vector3(position.x, 55, position.y);
		position.add(new THREE.Vector3(pan.x,0,pan.z));
...
THREE.EarthControls = function ( camera, renderer, scene ) {
	...
	function onMouseDown( event ) {
        ...
        console.log(scope.pivotNode.position);
...
function getMousePointCloudIntersection(mouse, camera, renderer, pointclouds){
    ...
    //if(closestPoint){ checkBoxes(closestPoint)}
